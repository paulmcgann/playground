...
namespace ContentCleaner.Services
{
    public class ContentTypeService : IContentTypeService
    {
        ...
        public ContentTypeService(IContentLoader contentLoader, IContentTypeRepository contentTypeRepository, IContentModelUsage contentModelUsage, EditUrlResolver editUrlResolver)
        {
